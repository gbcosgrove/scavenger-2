...
describe HuntsController do
  ...
  let(:valid_attributes) { { "challenge_count" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hunt as @hunt" do
        ...
        post :create, {:hunt => { "challenge_count" => "invalid value" }}, valid_session
        assigns(:hunt).should be_a_new(Hunt)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hunt" do
        ...
        Hunt.any_instance.should_receive(:update).with({ "challenge_count" => "1" })
        put :update, {:id => hunt.to_param, :hunt => { "challenge_count" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hunt as @hunt" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hunt.any_instance.stub(:save).and_return(false)
        put :update, {:id => hunt.to_param, :hunt => { "challenge_count" => "invalid value" }}, valid_session
        assigns(:hunt).should eq(hunt)
      end
